...
name="metode">
<option value="BRI" {{ $pembayaran->metode == 'BRI' ? 'selected' : '' }}>BRI</option>
<option value="BCA" {{ $pembayaran->metode == 'BCA' ? 'selected' : '' }}>BCA</option>
<option value="Mandiri" {{ $pembayaran->metode == 'Mandiri' ? 'selected' : '' }}>Mandiri</option>
</select>
...
value="{{ $pembayaran->kode_pelanggan }}">
<input type="text" class="form-control @error('kode') is-invalid @enderror"
placeholder="Cari Kode Pelanggan" id="kode" name="kode"
value="{{ $pembayaran->kode_pelanggan }}" aria-label="Cari Kode Pelanggan"
