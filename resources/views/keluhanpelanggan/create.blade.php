...
@stop
@section('content')
<form action="{{ route('keluhanpelanggan.store') }}" method="post">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
...
@error('id_users') is-invalid @enderror" id="id_users" placeholder="Id Users" name="id_users" value="{{ Auth::user()->id }}">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('keluhanpelanggan.index') }}" class="btn btn-danger">Batal</a>
                    </div>
                </div>
            </div>
        </div>
