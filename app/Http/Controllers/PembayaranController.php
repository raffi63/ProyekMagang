...
class PembayaranController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if (!$pembayaran) {
            return redirect()->route('pembayaran.index')->with('error_message', 'Pembayaran dengan id = ' . $id . ' tidak ditemukan');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pembayaran.index')->with('success_message', 'Berhasil Mengubah Pembayaran');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pembayaran.index')->with('success_message', 'Berhasil Menghapus Pembayaran');
    }
}
